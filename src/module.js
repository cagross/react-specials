...
export function apiData() {
    ...
    let proxyURL = ''
    console.log(555);
    console.log(process.env.CORS_PROXYURL);

    if (process.env.CORS_PROXYURL) {// If an environmental variable named CORS_PROXYURL exists, set its value as the proxy URL.
      console.log(666);
      console.log(process.env.CORS_PROXYURL);
      proxyURL = process.env.CORS_PROXYURL
